...
const projects = [
  ...
  },
  {
    ...
    description: "A order food app built using basic java.",
    tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
    Previewlink: "assets/video/project-page/OrderAppShipper.mp4",
    Githublink: "",
  },
  // {
  //   title: "Quiz App",
    ...
    <div class="column skill-card card">
      <div class="wrapper" style="background: url(${cardImage}) center / cover no-repeat;">
        ...
        <ul class="menu-content"><br>
              <li><a href="${Previewlink}" data-src="${Previewlink}" data-toggle="modal" data-target="#myModal" class="social-icon video-btn"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" viewBox="0 0 30 28" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-monitor"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"></rect><line x1="8" y1="21" x2="16" y2="21"></line><line x1="12" y1="17" x2="12" y2="21"></line></svg></a></li>
